...
symlink "$DOTFILES_DIR/.config/lazygit/config.yml" "$HOME/Library/Application Support/lazygit/config.yml"
...
# photos-logs.sh and photos-sync-now.sh are installed by setup-osxphotos-smb.sh
